...
export type ProductVariantContentFragment = {
  __typename?: 'ProductVariant';
  id: string;
  sku?: string | null;
...
export type ProductContentFragment = {
  ...
  options?: Array<{
    ...
    id: string;
    title: string;
    values: Array<{ __typename?: 'ProductOptionValue'; value: string }>;
  }> | null;
  variants?: Array<{
    __typename?: 'ProductVariant';
    id: string;
...
export type GetProductsPreviewQueryVariables = Exact<{
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  handle?: InputMaybe<Scalars['String']['input']>;
  region_id?: InputMaybe<Scalars['String']['input']>;
...
export type GetProductsPreviewQuery = {
  __typename?: 'Query';
  products: {
    __typename?: 'ProductListResponse';
    count: number;
    products?: Array<
      ({ __typename?: 'Product' } & ProductPreviewFragment) | null
    > | null;
  };
};
...
export type GetProductContentByHandleQueryVariables = Exact<{
  handle?: InputMaybe<Scalars['String']['input']>;
  region_id?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
}>;

export type GetProductContentByHandleQuery = {
  __typename?: 'Query';
  products: {
    __typename?: 'ProductListResponse';
    products?: Array<
      ({ __typename?: 'Product' } & ProductContentFragment) | null
    > | null;
  };
};
...
export type GetProductPricingQuery = {
  __typename?: 'Query';
  product?: {
    __typename?: 'Product';
    id: string;
...
export type GetCollectionsSummaryQuery = {
  __typename?: 'Query';
  collections: Array<{ __typename?: 'Collection'; id: string; title: string }>;
};
...
export const ProductVariantContentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'ProductVariantContent' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'ProductVariant' },
      },
...
} as unknown as DocumentNode<ProductVariantContentFragment, unknown>;
export const ProductVariantPricingFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'ProductVariantPricing' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'ProductVariant' },
      },
...
} as unknown as DocumentNode<ProductVariantPricingFragment, unknown>;
...
export const ProductContentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'manageInventory' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'options' },
...
} as unknown as DocumentNode<ProductContentFragment, unknown>;
...
export const ProductPreviewFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'ProductPreview' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'Product' },
      },
...
} as unknown as DocumentNode<ProductPreviewFragment, unknown>;
...
export const GetProductsPreviewDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetProductsPreview' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  GetProductsPreviewQuery,
  GetProductsPreviewQueryVariables
>;
...
export const GetProductContentByHandleDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetProductContentByHandle' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
>;
export const GetProductPricingDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetProductPricing' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
