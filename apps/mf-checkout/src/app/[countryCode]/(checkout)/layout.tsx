import MedusaCTA from '@gfed-medusa/sf-lib-checkout/components/medusa-cta';
      ...
      <div className="h-16 border-b bg-white">
        <nav className="content-container flex h-full items-center justify-between">
          ...
          >
            ...
            <span className="txt-compact-plus text-ui-fg-subtle hover:text-ui-fg-base small:block mt-px hidden">
              Back to shopping cart
            </span>
            <span className="txt-compact-plus text-ui-fg-subtle hover:text-ui-fg-base small:hidden mt-px block">
              Back
            </span>
          </LocalizedClientLink>
          <LocalizedClientLink
